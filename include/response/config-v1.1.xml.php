...
<clientConfig version="1.1">
    <emailProvider id="<?php echo substr($this->user['email'], strpos($this->user['email'], '@')+1) ?>">
        ...
        <incomingServer type="imap">
            <hostname><?php echo (defined('IMAP_SERVER_FQDN') ? IMAP_SERVER_FQDN : $this->host['hostname']) ?></hostname>
            <port>993</port>
        ...
        <incomingServer type="pop3">
            <hostname><?php echo (defined('POP_SERVER_FQDN') ? POP_SERVER_FQDN : $this->host['hostname']) ?></hostname>
            <port>995</port>
            <socketType>SSL</socketType>
            <authentication>password-cleartext</authentication>
            <username><?php echo $this->user['login'] ?></username>
        ...
        <outgoingServer type="smtp">
            <hostname><?php echo (defined('SMTP_SERVER_FQDN') ? SMTP_SERVER_FQDN : $this->host['hostname']) ?></hostname>
            <port>465</port>
            <socketType>SSL</socketType>
            <authentication>password-cleartext</authentication>
            <username><?php echo $this->user['login'] ?></username>
